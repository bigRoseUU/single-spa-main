[ { templateParameters: [Function: templateParameters],
    template: '/Users/linjiamin/github/single-spa-main/public/index.html' } ]
{
  mode: 'production',
  context: '/Users/linjiamin/github/single-spa-main',
  devtool: 'sourcemap',
  node: {
    setImmediate: false,
    dgram: 'empty',
  ...
  output: {
    path: '/Users/linjiamin/github/single-spa-main/dist',
    filename: 'js/[name].[contenthash:8].js',
    publicPath: '/single-app/main/',
    chunkFilename: 'js/[name].[contenthash:8].js',
    libraryTarget: 'umd',
    library: 'single-spa-main',
    jsonpFunction: 'webpackJsonp_single-spa-main'
  },
  resolve: {
    alias: {
      '@': '/Users/linjiamin/github/single-spa-main/src',
    ...
    modules: [
      'node_modules',
      '/Users/linjiamin/github/single-spa-main/node_modules',
      '/Users/linjiamin/github/single-spa-main/node_modules/@vue/cli-service/node_modules'
    ]
  },
  resolveLoader: {
    modules: [
      '/Users/linjiamin/github/single-spa-main/node_modules/@vue/cli-plugin-typescript/node_modules',
      '/Users/linjiamin/github/single-spa-main/node_modules/@vue/cli-plugin-babel/node_modules',
      'node_modules',
      '/Users/linjiamin/github/single-spa-main/node_modules',
      '/Users/linjiamin/github/single-spa-main/node_modules/@vue/cli-service/node_modules'
    ]
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/linjiamin/github/single-spa-main/node_modules/.cache/vue-loader',
              cacheIdentifier: '5589d13e'
            }
          },
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          /* config.module.rule('js').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/linjiamin/github/single-spa-main/node_modules/.cache/babel-loader',
              cacheIdentifier: '5eb648d1'
            }
          },
      ...
      /* config.module.rule('ts') */
      {
        ...
        use: [
          /* config.module.rule('ts').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/linjiamin/github/single-spa-main/node_modules/.cache/ts-loader',
              cacheIdentifier: 'dd9775dc'
            }
          },
  ...
  plugins: [
    ...
    new CopyWebpackPlugin(
      [
        {
          from: '/Users/linjiamin/github/single-spa-main/public',
          to: '/Users/linjiamin/github/single-spa-main/dist',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
